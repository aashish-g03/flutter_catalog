...
class CatalogMenuItem {
  CatalogMenuItem(this.title,
      {this.iconData, this.onTap, this.route, this.selected = false});
...
class _MenuScreen1State extends State<MenuScreen1> {
  List<CatalogMenuItem> menuList = [
    CatalogMenuItem(StringConst.HOME,
        iconData: FeatherIcons.home, onTap: () {}),
    CatalogMenuItem(StringConst.MEET_UPS,
        iconData: FeatherIcons.users, onTap: () {}),
    CatalogMenuItem(StringConst.EVENTS,
        iconData: FeatherIcons.calendar, onTap: () {}),
    CatalogMenuItem(StringConst.CONTACT_US,
        iconData: FeatherIcons.user, onTap: () {}),
    CatalogMenuItem(StringConst.ABOUT_US,
        iconData: FeatherIcons.info, onTap: () {}),
  ];
