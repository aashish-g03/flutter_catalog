...
/// The selected tab bubble is applied padding by [paddings] when [tabBarIndicatorSize] is label.
...
class CustomBubbleTabIndicator extends Decoration {
  ...
  const CustomBubbleTabIndicator({
    ...
    this.paddings: const EdgeInsets.symmetric(vertical: 2.0, horizontal: 8.0),
  ...
  Decoration? lerpFrom(Decoration? a, double t) {
    if (a is CustomBubbleTabIndicator) {
      return new CustomBubbleTabIndicator(
        paddings: EdgeInsetsGeometry.lerp(a.paddings, paddings, t),
  ...
  Decoration? lerpTo(Decoration? b, double t) {
    if (b is CustomBubbleTabIndicator) {
      return new CustomBubbleTabIndicator(
        paddings: EdgeInsetsGeometry.lerp(paddings, b.paddings, t),
...
class _BubblePainter extends BoxPainter {
  ...
  EdgeInsetsGeometry? get padding => decoration.paddings;

  EdgeInsetsGeometry? get insets => decoration.insets;

  TabBarIndicatorSize? get tabBarIndicatorSize =>
      decoration.tabBarIndicatorSize;
